...
class WsArticle
{
    ...
    public $QteCIDSsCFAD = 0;
    public $UVteArt = "";
    public $UStoArt = "";
    public $CvStoVteAD = 0.0;
    public $TypCvStoVteAD = false;
    public $NbUStoCondVteAD = 0;
    public $PoidsUVteArt = 0.0;
    public $NbUVteUCondVte = 0.0;
    public $PrixPubUCondVte = 0.0;
    public $PrixNetUCondVte = 0.0;
    public $NbUStoUVte = 0;
    public $NbUVteUSto = 0;

    public $NbrDecArt = 0.0;
    public $LongAD = 0.0;
    public $LargAD = 0.0;
    public $EpaisAD = 0.0;
    public $CondVteAD = "";
    public $FlgDecondAD = false;
    public $Desi2Art = "";
    public $IdFour = 0;
    public $NomDep = "";
    public $CodSuspAD = "";
    public $MultimediaArt = "";
    public $ComTechAD = "";
    public $DocLie = "";
    public $GenCodAD = "";
    public $CodEcoTaxeAD = "";
    public $MtEcoTaxe = 0.0;
    public $ValEcoTaxe = 0.0;
    public $IdDepPlat = 0;
    public $IdADF = 0;
    public $CodADF = "";
    public $GenCod1ADF = "";
    ...
    public $PrixNet = 0.0;
    public $PrixPubCli = 0.0;
    public $PrixPubAD = 0.0;
    public $TypeTarif = "";
    public $PrixRevConvAD = 0.0;
    public $PrixRevReelAD = 0.0;
    public $CoefPRRAD = 0.0;
    public $CoefPRCAD = 0.0;
    public $MargeReelleAD = 0.0;
    public $MargeConvAD = 0.0;
