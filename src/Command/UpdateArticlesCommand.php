...
class UpdateArticlesCommand extends ContainerAwareCommand
{
    ...
    private function dumpArticles($dbhost, $dbname, $dbuser, $dbpassword)
    {
        ...
        while($dumpedArticle = $reponseArticles->fetch ())
        {
            ...
            $article->setPrixPubAD(floatval($dumpedArticle['PrixPubAD']));
            ...
            $article->setFlgAncAD (boolval($dumpedArticle['FlgAncAD']));
            $article->setFlgCatalogAD (boolval($dumpedArticle['FlgCatalogAD']));
            $article->setFlgHorsMarqueAD(boolval($dumpedArticle['FlgHorsMarqAD']));
            $article->setFlgPrincAD (boolval($dumpedArticle['FlgDecliPrincAD']));
            $article->setFlgDestockAD (boolval($dumpedArticle['FlgDestockAD']));
            $article->setFlgNouvAD (boolval($dumpedArticle['FlgNouvAD']));
            $article->setFlgPromoAD (boolval($dumpedArticle['FlgPromoAD']));
            $article->setFlgVisibleAD (boolval($dumpedArticle['FlgVisibleAD']));
            $article->setFlgEclVertAD (boolval($dumpedArticle['FlgEclVertAD']));
            $article->setFlgEclBleuAD (boolval($dumpedArticle['FlgEclBleuAD']));
            $article->setFlgEclOrangeAD (boolval($dumpedArticle['FlgEclOrangeAD']));
            $article->setFlgEclRoseAD (boolval($dumpedArticle['FlgEclRoseAD']));
