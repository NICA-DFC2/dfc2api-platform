...
class Four
{
    ...
    private $APEFour;
    private $CapitalFour;
    private $CodCentraleFour;
    private $CodCliFour;
    private $CodFour;
    private $CodGroupeFour;
    private $CodPaysFour;
    private $CodSectFour;
    private $CodSuiviFour;
    private $CodSuspFour;
    private $CollectifFour;
    private $ComFour;
    private $DateCreFour;
    private $DatModFour;
    private $DelaiFour;
    private $DelaiNbJPaiEscFour;
    private $EchRegFour;
    private $FinMoisDelaiEscFour = false;
    private $FinMoisFour = false;
    private $FlgARFour = false;
    private $FlgComptaFour = false;
    private $FlgDEBFour = false;
    private $FlgReliquatFour = false;
    private $FlgTvaEncFour = false;
    private $FormJurFour;
    private $FraisFacAchFour = false;
    private $FreqAchFour;
    private $GLNFour;
    private $IdAdr;
    private $IdCpt;
    ...
    private $IdUMod;
    private $JRegFour;
    private $LstIdSocDepFour;
    private $LstIdUBlocFour;
    private $LstJoursLivFour;
    private $LstVentilFour;
    private $MinCmdFour;
    private $MontPortAutoFour;
    private $MotsClesAutoFour;
    private $MotsClesFour;
    private $MRegFour;
    private $NbJrSecuFour;
    private $NoComptaFour;
    private $NoFour;
    private $NumTvaFour;
    private $PriseChargeSavFour;
    private $RgpFour;
    private $RSocFacFour;
    private $RSocFour;
    private $RSocUsFour;
    ...
    private $TypeFour;
    private $TypeTvaFour;
    private $UFranco2Four;
    private $UFrancoFour;
    private $VFranco2Four;
    private $VFrancoFour;
     ...
     */
    public function parseObject(WsFour $json_object=null) {
